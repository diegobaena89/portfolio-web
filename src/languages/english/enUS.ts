export const enUS = {
  ...
  about: {
    ...
    education: {
      title: "Education",
      fam: {
        institution: "Metropolitan University (FAM)",
        date: "Dec/2022 - Dec/2023",
        course: "Software Engineering",
      },
      unip: {
        institution: "Paulist University (UNIP)",
        date: "Jan/2020 - Dec/2021",
        course: "System Development and Analysis",
      },
      usp: {
        institution: "University of Sao Paulo (USP)",
        date: "Jan/2019 - Dec/2020",
        course: "Master's Degree in Greek Language and Literature",
      },
      usp2: {
        institution: "University of Sao Paulo (USP)",
        date: "Feb/2015 - Dec/2019",
        course: "Specialization in Czech Language and Literature",
      },
    },
    jobs: {
      work: "work",
      experience: "experience",
      bees: "Front-end developer responsible for expanding and maintaining a B2B application using ReactJS and TypeScript. I created unit and component tests, implemented BFFs with Nest.js, and contributed to the development of a shared library to enhance usability across multiple teams.",
      alpar:
    ...
    projects: {
      ...
      waiter: {
        title: "Waiter app",
        description:
          "This is a web and mobile application that will be aimed at bar and restaurant waiters. In this app, the waiter will be able to record customer orders, which will be automatically forwarded to the dashboard where orders will be stored according to each customer.",
        stack: [
          "ReactJS",
          "Node",
          "MongoDB",
      ...
      ecommerce: {
        title: "E-commerce",
        description:
          "This is a React TypeScript application built with Chakra UI, designed to provide a simple online shopping experience. We fetch product data from the FakeStore API to simulate a real e-commerce store.",
        stack: ["Typescript", "React", "Chrakra UI"],
        imgUrl:
      ...
      password: {
        ...
        description:
          "It provides real-time feedback and guidance on creating robust and secure passwords, making it an essential tool for anyone concerned about online security. Strengthen your digital defenses today with this open-source password strength checker!",
        stack: ["Typescript", "React", "Chrakra UI"],
        imgUrl:
